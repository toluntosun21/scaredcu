from scaredcu import selection_functions as _sf, container as _container, models, distinguishers
import cupy as _cu
import logging
...
class BaseAttack(_BaseAnalysis):
    ...
    def _compute_convergence_traces(self):
        ...
        if self.convergence_traces is None:
            ...
            self.convergence_traces = _cu.empty(self.scores.shape + (0, ), dtype=self.precision)
        self.convergence_traces = _cu.append(self.convergence_traces, self.scores[..., None], axis=-1)
