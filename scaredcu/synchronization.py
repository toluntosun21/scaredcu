...
class Synchronizer:
    ...
    def check(self, nb_traces=5, catch_exceptions=True):
        ...
        """
        result = []
        random_indexes = _cu.random.choice(_cu.arange(len(self.input_ths)), nb_traces)
    ...
    def __str__(self):
        ...
        out_str += f"Success rate........: {_cu.round(self.synchronized_counter / self.processed_counter * 100, decimals=2)}%"
        return out_str
